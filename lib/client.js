...
class Client {
   ...
   */
  getOnDemandConfig(serviceName, functionName, qualifier, options = {}, headers = {}) {
   ...
   * @return {Promise} 返回 Object(包含 headers 和 data 属性[onDemandConfig 信息])
   */
  putOnDemandConfig (serviceName, functionName, qualifier, options = {}, headers = {}) {
   ...
   * @return {Promise} 
   */
  deleteOnDemandConfig(serviceName, functionName, qualifier, options = {}, headers = {}) {
